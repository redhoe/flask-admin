...
Revision ID: 8b456af3cd6d
Revises: 384ac18b5eb6
Create Date: 2020-07-05 12:40:56.480251
...
revision = '8b456af3cd6d'
down_revision = '384ac18b5eb6'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('capital', sa.Column('balance', sa.String(length=30), nullable=True))
...
def downgrade():
    ...
    op.drop_column('capital', 'balance')
    # ### end Alembic commands ###
